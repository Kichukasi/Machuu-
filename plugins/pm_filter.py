...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🤖 Updates', url='https://t.me/bettermalayalam')
            ],[
...
async def advantage_spell_chok(msg):
    ...
    await msg.reply("I couldn't find anything related to that\nDid you mean any one of these?🕵️‍♂️ Search On Google 🕵️‍♂️[click here](buttonurl://https://google.com/search?q={search}) ", reply_markup=InlineKeyboardMarkup(btn))
